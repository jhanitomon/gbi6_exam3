...
ggcorrplot(corr_matrix, hc.order = TRUE, type = "lower", lab = TRUE,
           ...
           title = "Correlation plot of gene expression data",
           ggtheme = ggplot2::theme_bw(),
           legend.title = "Correlation",
           legend.params = list(size = 8, shape = 16, color = "black"))
...
**Cada gen esta representado por cada fila y cada tejido esta representado por cada columna,los niveles de expresión de cada muestra estan representados por los colores;el color rojo indica expresión elevada y el color azul expresión baja;por otro lado la intensidad de los colores indica el tamaño de la expresión;utiliza un método por correlación no jerarquico para agrupar los genes y muestras.**
